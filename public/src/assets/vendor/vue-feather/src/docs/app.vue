      ...
      <nav class="container">
        ...
        >
          <nav class="nav navbar-nav">
            ...
            <a class="nav-link" href="//github.com/fengyuanchen/vue-feather/blob/master/LICENSE">
              License
            </a>
            <a
              class="nav-link"
            ...
            <a class="nav-link" href="//fengyuanchen.github.io" title="Explore more projects">
              Explore
            </a>
      ...
      <div class="jumbotron bg-primary text-white rounded-0">
        <div class="container">
          <div class="row">
            <div class="col-md">
              <h1>
                {{ name }} <small class="h6"> v{{ version }} </small>
              </h1>
              <p class="lead">
                {{ description }}
              </p>
            ...
            <div class="col-md">
              <div ref="carbonads" class="carbonads" />
            </div>
          </div>
        </div>
      </div>
    ...
    <footer>
      <div class="container">
        ...
        <nav class="nav flex-wrap justify-content-center mb-3">
          <a class="nav-link" href="//github.com/fengyuanchen/vue-feather"> GitHub </a>
          <a class="nav-link" href="//github.com/fengyuanchen/vue-feather/blob/master/LICENSE">
            License
          </a>
